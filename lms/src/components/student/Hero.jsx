...
const Hero = () => {
  return (
    ...
    <p className='md:block hidden text-default text-gray-500 max-w-2x1 mx-auto'>We bring together world-class instructors fsefesfesfes esfesfefesfes efsefesfesfes efesesfesfesfes efesfesfes</p>

    <p className='md:hidden text-default text-gray-500 max-w-sm mx-auto'>We birng in world class fesfesfesfesfesbubiuiuubu</p>
    <SearchBar/>
    </div>
  )
}
